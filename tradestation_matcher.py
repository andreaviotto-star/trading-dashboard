...
def compute_system_breakdown(matched_df: pd.DataFrame, override_df: pd.DataFrame,
    ...
    def _theo_pnl_for(m: pd.DataFrame, o: pd.DataFrame, u: pd.DataFrame, stem: str) -> float:
        ...
        return (raw - comm * total_contracts) * scale
    ...
    for sysname in sorted(systems):
        ...
        theo_pnl = _theo_pnl_for(m, o, u, stem)
        actual_pnl = _col_sum(m, "actual_pnl_net") + _col_sum(o, "actual_pnl_net")
        commissions = _col_sum(m, "commission") + _col_sum(o, "commission")
        slippage = _col_sum(m, "actual_pnl_gross") - _col_sum(m, "theo_pnl")
        override_impact = _col_sum(o, "actual_pnl_gross") - _col_sum(o, "theo_pnl")
        unmatched_impact = -_col_sum(u, "pnl")  # theoretical P&L never realized
